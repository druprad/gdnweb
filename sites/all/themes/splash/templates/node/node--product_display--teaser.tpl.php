    ...
    <article class="post">
        <figure>
            <div class="text-overlay"> 
               <div class="info">
                   <span><a href="<?php print $node_url;?>">View + Details</a></span>
               </div>
                <div class="meta">
                 <ul>
                      <li>
                      ...
                      <li><i class="fa fa-shopping-cart"></i><?php print render($content['field_product']);?></li>
                 </ul>
                </div>
            </div>
            
            <?php if (isset($content['product:field_product_characteristics']["#object"])) :?>
            <?php 
                $character = $content['product:field_product_characteristics']['#object']->field_product_characteristics["und"]["0"]["taxonomy_term"]->name; 
            ?>
                <span class="sale"><?php print $character;?></span>
